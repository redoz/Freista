...
namespace PUnit.Generated
{
    internal static class PUnitGenerated
    {
        ...
        {
            global::PUnit.ScenarioRegistry.Register("ResourceDemo.ResourceScenarios.SuspendedUserCannotSignIn", Scenario_ResourceDemo_ResourceScenarios_SuspendedUserCannotSignIn);
        }

        public static global::PUnit.Model.ScenarioDefinition Scenario_ResourceDemo_ResourceScenarios_SuspendedUserCannotSignIn()
        {
            var nodes = new global::PUnit.Model.ScenarioNode[3];
