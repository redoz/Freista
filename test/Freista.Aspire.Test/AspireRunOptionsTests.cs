...
namespace Freista.Aspire.Test;

/// <summary>
/// Unit coverage for the parts of Freista.Aspire that need no container runtime. Actually standing
...
public class AspireRunOptionsTests
{
    ...
    public void Aspire_throws_an_actionable_message_when_no_application_is_registered()
    {
        ...
        Assert.Contains("FreistaAspire.RunAsync", ex.Message, StringComparison.Ordinal);
        Assert.Contains("FreistaGenerateProgram", ex.Message, StringComparison.Ordinal);
    }
