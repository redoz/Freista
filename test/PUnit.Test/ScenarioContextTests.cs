...
public class ScenarioContextTests
{
    ...
    public void Exposes_step_identity_and_cancellation()
    {
        ...
        var ctx = new ScenarioContext("step-1", "patient Jane exists", cts.Token, services: null);
    ...
    {
        var ctx = new ScenarioContext("s", "n", CancellationToken.None, services: null);
    ...
    public void Resolves_services_from_provider()
    {
        ...
        var ctx = new ScenarioContext("s", "n", CancellationToken.None, provider);
