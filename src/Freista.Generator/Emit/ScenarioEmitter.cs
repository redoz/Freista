...
internal static class ScenarioEmitter
{
    ...
    public static string Emit(IReadOnlyList<ParsedScenario> scenarios)
    {
        ...
        var classDecl = ClassDeclaration("FreistaGenerated")
            .AddModifiers(Token(SyntaxKind.InternalKeyword), Token(SyntaxKind.StaticKeyword))
            .WithMembers(List(members));

        var nsDecl = NamespaceDeclaration(ParseName("Freista.Generated")).AddMembers(classDecl);
    ...
    private static MethodDeclarationSyntax BuildCreateAll(IReadOnlyList<ParsedScenario> scenarios)
    {
        ...
        {
            // global::System.Array.Empty<global::Freista.Model.ScenarioDefinition>()
                ...
                MemberAccessExpression(
                    ...
                    GenericName(Identifier("Empty"))
                        .WithTypeArgumentList(TypeArgumentList(SingletonSeparatedList<TypeSyntax>(
                            ParseTypeName("global::Freista.Model.ScenarioDefinition"))))))
                .WithArgumentList(ArgumentList());
        }
        else
        {
            // new global::Freista.Model.ScenarioDefinition[] { Scenario_X(), ... }
            ...
            body = ArrayCreationExpression(
                ArrayType(ParseTypeName("global::Freista.Model.ScenarioDefinition"))
        ...
        return MethodDeclaration(
                ParseTypeName("global::System.Collections.Generic.IReadOnlyList<global::Freista.Model.ScenarioDefinition>"),
                "CreateAll")
    ...
    {
        // global::Freista.ScenarioRegistry.Register("...", Scenario_X);
        var statements = scenarios.Select(s =>
            (StatementSyntax)ExpressionStatement(
                InvocationExpression(
                    MemberAccessExpression(
                        SyntaxKind.SimpleMemberAccessExpression,
                        ParseName("global::Freista.ScenarioRegistry"),
    ...
    {
        // var nodes = new global::Freista.Model.ScenarioNode[N];
        var arrayExpr = ArrayCreationExpression(
            ArrayType(ParseTypeName("global::Freista.Model.ScenarioNode"))
                .WithRankSpecifiers(SingletonList(
                    ArrayRankSpecifier(SingletonSeparatedList<ExpressionSyntax>(
        ...
        var definition = ObjectCreationExpression(ParseTypeName("global::Freista.Model.ScenarioDefinition"))
    ...
    private static ObjectCreationExpressionSyntax BuildNode(ParsedStep step)
    {
        ...
        return ObjectCreationExpression(ParseTypeName("global::Freista.Model.ScenarioNode"))
