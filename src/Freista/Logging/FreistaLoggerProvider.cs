...
/// </remarks>
public sealed class FreistaLoggerProvider : ILoggerProvider
{
    /// <summary>Creates a logger writing to whichever step is running when each write happens.</summary>
    public ILogger CreateLogger(string categoryName) => new FreistaLogger(categoryName);
...
/// </list>
/// </remarks>
internal sealed class FreistaLogger(string category, ScenarioContext? bound = null) : ILogger
{
