...
namespace Freista.Mtp.HtmlReport;

/// <summary>
/// Registers Freista's HTML-report command-line options with Microsoft.Testing.Platform:
...
/// (design §3.E). Generic names — Freista owns its loaded extension set, so collision risk is low.
/// </summary>
internal sealed class HtmlReportOptionsProvider : ICommandLineOptionsProvider
{
    ...
    public string DisplayName => "Freista HTML report";
