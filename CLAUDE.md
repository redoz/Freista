...
## Project
`PUnit`: a Microsoft.Testing.Platform test framework (Given/When/Then DSL, Roslyn source-gen, DAG parallel scheduler, object-flow tracking, self-contained HTML report). Build/test via `dotnet` on `PUnit.slnx`.
